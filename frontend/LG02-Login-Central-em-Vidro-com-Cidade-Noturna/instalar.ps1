...
@media(max-width:700px){html,body{overflow:auto}.lg02{min-height:800px;padding:18px;overflow:hidden}.lg02-card{min-height:760px;padding:28px 22px;border-radius:24px}.lg02-stage{min-height:640px}.lg02 h1{font-size:39px}}
