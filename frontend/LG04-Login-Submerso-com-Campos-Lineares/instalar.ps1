...
*{box-sizing:border-box}html,body{margin:0;min-height:100%;overflow:hidden;background:#032732;color:var(--ink);font-family:Arial,Helvetica,sans-serif}button,input{font:inherit}body{min-height:100svh}
...
@media(max-width:700px){html,body{overflow:auto}.lg04{align-items:start;min-height:790px;padding-top:28px;background-position:58% center}.lg04-access{height:730px}.lg04-avatar{width:96px;height:96px}.lg04-avatar svg{width:50px;height:50px}.lg04-view{inset:120px 0 0}.lg04 h1{font-size:42px}.lg04-note{display:none}}
