...
#catalogo-f02 .f02-hero{display:grid;grid-template-columns:1.25fr .75fr;min-height:280px;border-top:1px solid #11110f24;border-bottom:1px solid #11110f}
#catalogo-f02 .f02-statement{padding:52px clamp(26px,6vw,92px);background:var(--cream);display:flex;flex-direction:column;justify-content:space-between}
#catalogo-f02 .f02-kicker{font-size:10px;font-weight:900;letter-spacing:.18em;text-transform:uppercase}
#catalogo-f02 .f02-statement h2{max-width:760px;margin:24px 0 0;font:500 clamp(42px,6vw,82px)/.92 Georgia,serif;letter-spacing:-.055em}
#catalogo-f02 .f02-news{padding:52px clamp(26px,5vw,70px);background:#11110f;color:#f7f1e8;display:flex;flex-direction:column;justify-content:flex-end}
#catalogo-f02 .f02-news h3{margin:0 0 9px;font:500 29px/1 Georgia,serif}#catalogo-f02 .f02-news p{margin:0 0 22px;color:#bcb6ae;font-size:13px;line-height:1.6}
...
#catalogo-f02 .f02-grid{display:grid;grid-template-columns:1.3fr repeat(3,1fr);gap:40px;padding:42px clamp(26px,6vw,92px);background:var(--paper)}
...
#catalogo-f02 .f02-strip{display:flex;align-items:center;justify-content:space-between;gap:20px;padding:16px clamp(26px,6vw,92px);background:var(--red);color:#fff8ef;font-size:11px}
#catalogo-f02 .f02-strip nav{display:flex;gap:18px;flex-wrap:wrap}
@media(max-width:820px){#catalogo-f02 .f02-hero{grid-template-columns:1fr}#catalogo-f02 .f02-news{min-height:240px}#catalogo-f02 .f02-grid{grid-template-columns:1fr 1fr}#catalogo-f02 .f02-brand{grid-column:1/-1}}
